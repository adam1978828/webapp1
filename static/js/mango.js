...
(function($$, $, undefined) {
    ...
    var mango = {
        ...
        config: {
            ...
            // Preloader settings
            preload: {
                enabled: false, // boolean: Enable/disable the image preloader
        ...
        utils: {
            ...
            loaded: function(cb) {
                ...
                $.isFunction(cb) ? _cb.push(mango.utils.tryF(cb)) : mango.loaded.run = true | _cb.forEach(function(f) {
                    f()
                });
        ...
        register: function(name, dependencies, wrapper, func) {
            ...
            registry[opts.name] = function(cb, dfd) {
                ...
                // TODO: Run callback directly, if it already has been loaded
